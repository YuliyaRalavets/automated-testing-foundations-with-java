...
import planeModel.planes.ExperimentalPlane;
import planeModel.ClassificationLevel;
import planeType.ExperimentalType;
import planeType.MilitaryType;
import org.testng.Assert;
import org.testng.annotations.Test;
import planeModel.planes.MilitaryPlane;
import planeModel.planes.PassengerPlane;
...
public class AirportTest {
    ...
    private static Plane[] arrayOfPlanes = {
            ...
            new ExperimentalPlane(PlaneProducer.Bell_X_14, ExperimentalType.HIGH_ALTITUDE, ClassificationLevel.SECRET),
            new ExperimentalPlane(PlaneProducer.Ryan_X_13_VERTIJET, ExperimentalType.VTOL, ClassificationLevel.TOP_SECRET)
    };
